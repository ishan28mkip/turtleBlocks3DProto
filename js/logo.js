...
function Logo(canvas, blocks, turtles, stage, refreshCanvas, textMsg, errorMsg,
    ...
    this.runFromBlockNow = function(logo, turtle, blk) {
        ...
        switch (logo.blocks.blockList[blk].name) {
            ...
            case 'increment':
                ...
                break;
            case 'setCursorPositionX':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        logo.errorMsg('Not a number.', blk);
                        logo.stopTurtle = true;
                    } else {
                        logo.turtles.turtleList[turtle].setCursorPositionX(args[0]);
                    }
                }
                break;
            case 'setCursorPositionY':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        logo.errorMsg('Not a number.', blk);
                        logo.stopTurtle = true;
                    } else {
                        logo.turtles.turtleList[turtle].setCursorPositionY(args[0]);
                    }
                }
                break;
            case 'setCursorPositionZ':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        logo.errorMsg('Not a number.', blk);
                        logo.stopTurtle = true;
                    } else {
                        logo.turtles.turtleList[turtle].setCursorPositionZ(args[0]);
                    }
                }
                break;
            case 'setCursorPosition':
                if (args.length == 3) {
                    if (typeof(args[0]) == 'string' || typeof(args[1]) == 'string' || typeof(args[2]) == 'string') {
                        ...
                        logo.turtles.turtleList[turtle].setCursorPosition(args[0], args[1],args[2]);
                    }
                }
                break;
            case 'doForwardX':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        ...
                        logo.turtles.turtleList[turtle].doForwardX(args[0]);
                    }
                }
                break;
            case 'doForwardY':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        ...
                        logo.turtles.turtleList[turtle].doForwardY(args[0]);
                    }
                }
                break;
            case 'doForwardZ':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        ...
                        logo.turtles.turtleList[turtle].doForwardZ(args[0]);
                    }
                }
                break;
            case 'setRoll':
            ...
            case 'doRoll':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        ...
                        logo.turtles.turtleList[turtle].doRoll(args[0]);
                    }
                }
                break;
            ...
            case 'doPitch':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        ...
                        logo.turtles.turtleList[turtle].doPitch(args[0]);
                    }
                }
                break;
            case 'doYaw':
                if (args.length == 1) {
                    if (typeof(args[0]) == 'string') {
                        ...
                        logo.turtles.turtleList[turtle].doYaw(args[0]);
                    }
                }
                break;
            ...
            //     break;
            // case 'setxy':
            //     if (args.length == 2) { //houston we have a small bug, typeof(args[1]) == 'sting' instead of 'string'
    ...
    //Found the background setting function.
